        ...
        <div class="row pt-5 m-auto">
            <div class="col-md-4 col-lg-4 pb-3">
                <div class="card card-custom bg-white border-white border-0">
                    <div class="card-custom-img" style="background-image: url('/img/man.jpg')"></div>
                    <div class="card-custom-avatar">
                        {{--<img class="img-fluid" src="http://res.cloudinary.com/d3/image/upload/c_pad,g_center,h_200,q_auto:eco,w_200/bootstrap-logo_u3c8dx.jpg" alt="Avatar" />--}}
                    </div>
                    <div class="card-body pt-2" style="overflow-y: hidden">
                        <h4 class="card-title"> علی عربگری</h4>
                        ...
                        <p>شغل : توسعه دهنده آی او اس</p>
                        <p>رشته تحصیلی : فناوری اطلاعات</p>
                    </div>
            ...
            <div class="col-md-4 col-lg-4 pb-3">
                <div class="card card-custom bg-white border-white border-0">
                    ...
                    <div class="card-body pt-2" style="overflow-y: hidden">
                        <h4 class="card-title"> بهرام نورایی</h4>
                        <p class="card-text"> سامانه همگام به منظور برقراری ارتباط فعال و سازنده مابین دانشجویان، اساتید و صنایع در شهریور ماه 1398 راه اندازی شد.
                        </p>
                        <p>شغل : توسعه دهنده وب</p>
                        <p>رشته تحصیلی : مهندسی نرم افزار</p>
                    </div>
                    {{--<div class="card-footer" style="background: inherit; border-color: inherit;">--}}
                        {{--<div align="right">--}}
                            {{--<a href="{{url('/skill-learning/courses')}}">--}}
